...
[`@aws-sdk/client-schemas`](https://www.npmjs.com/package/@aws-sdk/client-schemas/v/3.332.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-schemas@3.332.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B9a6uIs/WbhAdx4FIXygUaL2fv0BDoJyzGbvrifFJws66//N9Im4RZySBCKRVLEm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-schemas": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-schemas@3.332.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-schemas@3.332.0/index.min.mjs": "sha384-B9a6uIs/WbhAdx4FIXygUaL2fv0BDoJyzGbvrifFJws66//N9Im4RZySBCKRVLEm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-schemas/blob/refs/tags/3.332.0/LICENSE
```
